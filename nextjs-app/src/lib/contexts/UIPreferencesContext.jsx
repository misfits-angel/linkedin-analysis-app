...
export const CARD_DEFINITIONS = {
  ...
  'posting-activity-stats': { name: 'Posting Activity Stats', category: 'Analytics', defaultVisible: true },
  'linkedin-analytics': { name: 'LinkedIn Analytics', category: 'Analytics', defaultVisible: true },
  'post-type-mosaic': { name: 'Post Type Distribution', category: 'Analytics', defaultVisible: false },
  'engagement-trend-chart': { name: 'Engagement Over Time', category: 'Charts', defaultVisible: false },
  ...
  'top-topics-chart': { name: 'Post vs Reshare', category: 'Charts', defaultVisible: false },
  ...
  'ai-content-analysis': { name: 'Post Quality Evaluation', category: 'AI Analysis', defaultVisible: false },
  'ai-topic-analysis': { name: 'Topic Analysis', category: 'AI Analysis', defaultVisible: false },
  'ai-recommendations': { name: 'Positioning Analysis', category: 'AI Analysis', defaultVisible: false },
  ...
  'top-posts': { name: 'Top Posts', category: 'Content', defaultVisible: false },
