...
export default function TimingInsights({ data }) {
  ...
  return (
    <div>
        ...
        <div className="mb-4">
          ...
          <div className="text-xs text-muted-foreground mb-2">Shows: Posts count • Median engagement</div>
            ...
            {dayOrder.map(day => {
              ...
              return (
                ...
                >
                  {isActive ? (
                    <>
                      <div className="font-semibold text-gray-800">{dayAbbr[day]}</div>
                    ...
                    <>
                      <div className="font-semibold text-gray-400">{dayAbbr[day]}</div>
