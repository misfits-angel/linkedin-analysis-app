...
export default function TopicAnalysis({ postsData }: TopicAnalysisProps) {
  ...
  const handleAnalyzeTopics = async () => {
    ...
    try {
      ...
      const legacyFormat: TopicAnalysisResult = {
  ...
  return (
    <div className="card p-4">
      <div className="flex justify-between items-center mb-2">
        <div className="section-title-spaced">Topic insights</div>
        <LLMButton
