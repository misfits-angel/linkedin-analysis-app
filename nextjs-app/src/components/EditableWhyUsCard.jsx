...
export default function EditableWhyUsCard() {
  ...
  const handleSave = () => {
    if (editingField) {
      updateCardField('why-us', editingField, tempValue)
      setEditingField(null)
      setTempValue('')
      // Show a brief success indicator
      setTimeout(() => {
        // The save indicator will be shown by the context
      }, 100)
    }
  }
  ...
  const handleUpdateFeature = (index, field, value) => {
    updateCardItem('why-us', 'features', index, { [field]: value })
  }

  const handleRemoveFeature = (index) => {
    removeCardItem('why-us', 'features', index)
  }
