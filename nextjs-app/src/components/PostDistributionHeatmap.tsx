...
export default function PostDistributionHeatmap({ data }: PostDistributionHeatmapProps) {
  ...
  if (!heatmapData) {
    return (
      <div className="card p-4">
        <div className="section-title-spaced">📅 Post Distribution Heatmap</div>
        <div className="text-sm text-gray-600">Distribution data not available.</div>
      </div>
    )
  }
  ...
  const getEngagementColor = (engagement: number, count: number) => {
  ...
  return (
    <div className="card p-4">
      <div className="section-title-spaced">📅 Post Distribution</div>
      <div className="text-xs text-gray-500 mb-4">Last 12 months: {labelMonth(months[0])} - {labelMonth(months[months.length - 1])}</div>
      ...
      <div className="grid grid-cols-2 gap-6 mt-6">
        ...
        <div>
          ...
          <div className="overflow-x-auto">
            <div style={{ display: 'table', borderCollapse: 'collapse', minWidth: '400px', fontFamily: 'Arial, sans-serif' }}>
              {/* Header Row */}
              <div style={{ display: 'table-row', backgroundColor: '#D6E3DD' }}>
                <div style={{ display: 'table-cell', width: '120px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Day</div>
                <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Posts</div>
                <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Engagement</div>
              </div>
              ...
              {dayOrder.map((day) => {
                ...
                return (
                  <div key={day} style={{ display: 'table-row', backgroundColor: '#F6F5F1' }}>
                    <div style={{ display: 'table-cell', width: '120px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'left', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#F6F5F1' }}>
                      {dayAbbr[day as keyof typeof dayAbbr]}
                    </div>
                    <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#F6F5F1' }}>
              ...
              {/* Total Row */}
              <div style={{ display: 'table-row', backgroundColor: '#D6E3DD' }}>
                <div style={{ display: 'table-cell', width: '120px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'left', fontWeight: 'bold', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Total</div>
                <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'bold', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>
                  {Object.values(monthly_daily).reduce((sum, monthData) => 
                    sum + Object.values(monthData).reduce((daySum, cell) => daySum + cell.count, 0), 0
                  )}
                </div>
                <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'bold', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>
        ...
        <div>
          ...
          <div className="overflow-x-auto">
            <div style={{ display: 'table', borderCollapse: 'collapse', minWidth: '400px', fontFamily: 'Arial, sans-serif' }}>
              {/* Header Row */}
              <div style={{ display: 'table-row', backgroundColor: '#D6E3DD' }}>
                <div style={{ display: 'table-cell', width: '120px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Month</div>
                <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Posts</div>
                <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#D6E3DD' }}>Engagement</div>
              </div>
              ...
              {months.map((month) => {
                ...
                return (
                  <div key={month} style={{ display: 'table-row', backgroundColor: '#F6F5F1' }}>
                    <div style={{ display: 'table-cell', width: '120px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'left', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#F6F5F1' }}>
                      {labelMonth(month)}
                    </div>
                    <div style={{ display: 'table-cell', width: '80px', height: '32px', border: '1px solid #cccccc', padding: '4px 8px', textAlign: 'center', fontWeight: 'normal', fontSize: '12px', color: '#333333', backgroundColor: '#F6F5F1' }}>
